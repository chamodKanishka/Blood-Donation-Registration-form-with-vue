...
export default {
  setup() {
    ...
    const validateForm = () => {
      ...
      if (!form.value.blood_type) errors.blood_type = 'Blood type is required';
    ...
    const submitForm = async () => {
      ...
      try {
        ...
        resetForm(); // Optional: Reset form fields after successful submission
      } catch (error) {
          ...
          <div class="row g-3">
            ...
            <div class="col-md-5">
              ...
              <select class="form-select" id="prefecture"
                ...
                <option v-for="pref in prefectures"
                        :key="pref" :value="pref">{{ pref }}</option>
              </select>
              <div class="invalid-feedback">
            ...
            <div class="col-md-5">
              ...
              <select class="form-select" id="city"
                ...
                <option value="">Choose...</option>
                <option v-for="city in filteredCities"
            ...
            <div class="col-md-5">
              ...
              <input type="text"
                     ...
                     :class="{ 'is-invalid': validationErrors.blood_type }">
              <div class="invalid-feedback">
